...
- Per-tool schema-validated capability contracts are hashed into trust-baseline v2. Enforce mode blocks missing, changed, unsupported, and uncontained contracts.
...
- A packed/npx install smoke test and an actual Docker isolation run were not completed in this environment.
