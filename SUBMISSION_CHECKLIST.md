...
| Deterministic policy engine | Not started | — | Day 2 |
...
| Vulnerable demo and fixtures | Not started | — | Days 2 and 5 |
| Automated tests | In progress | `tests/unit`, `tests/integration` | 3 passing tests; expand security and E2E coverage |
